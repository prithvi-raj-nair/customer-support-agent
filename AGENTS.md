...
Email Input → [Input Guardrail] → Router
                ...
                ┌───────────────────┼───────────────────┐
                ▼                   ▼                   ▼
          [Main Agent]       [Human Queue]      [Default Response]
                │                   │                   │
                ▼                   │                   │
        [Output Guardrail]         │                   │
                │                   │                   │
...
- **Main Agent**: Tool-calling agent that fetches user/order data and composes responses
...
| Add new tools | `backend/agent/tools/` |
...
### Tool Validation (Code-based)
- `get_user_by_email`: Email must match sender
- `get_orders_for_user`: User ID must match validated user
